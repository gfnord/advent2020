...
def check_answers():
    ...
    for answers in all_groups:
        ...
        if persons_per_group == 2:
            ...
            #print('- ', len(set(person1).intersection(person2)), \
            #      set(person1).intersection(person2))
        if persons_per_group == 3:
            person1 = list(per_answer[0])
            person2 = list(per_answer[1])
            person3 = list(per_answer[2])
            answer_count += len(set(person1).intersection(person2, person3))
            #print('- ', len(set(person1).intersection(person2, person3)), \
                  #set(person1).intersection(person2, person3))
        if persons_per_group == 4:
            ...
            #print('- ', len(set(person1).intersection(person2, person3, \
                  #person4)), set(person1).intersection(person2, person3,\
                  #person4))
        if persons_per_group == 5:
            ...
            #print('- ', len(set(person1).intersection(person2, person3, \
                  #person4, person5)), set(person1).intersection(person2,\
